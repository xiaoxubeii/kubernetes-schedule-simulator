...
import (
	...
	factory "github.com/xiaoxubeii/kubernetes-schedule-simulator/pkg/scheduler/factory"
...
func init() {
	...
	factory.RegisterPredicateMetadataProducerFactory(
		func(args kfactory.PluginFactoryArgs) algorithm.PredicateMetadataProducer {
			return predicates.NewPredicateMetadataFactory(args.PodLister)
		})
	factory.RegisterPriorityMetadataProducerFactory(
		func(args kfactory.PluginFactoryArgs) algorithm.PriorityMetadataProducer {
	...
	factory.RegisterPriorityConfigFactory(
		...
		kfactory.PriorityConfigFactory{
			MapReduceFunction: func(args kfactory.PluginFactoryArgs) (algorithm.PriorityMapFunction, algorithm.PriorityReduceFunction) {
...
func defaultPredicates() sets.String {
	return sets.NewString(
		...
		factory.RegisterFitPredicateFactory(
			...
			func(args kfactory.PluginFactoryArgs) algorithm.FitPredicate {
...
func registerAlgorithmProvider(predSet, priSet sets.String) {
	...
	// by specifying flag.
	factory.RegisterAlgorithmProvider(kfactory.DefaultProvider, predSet, priSet)
...
func defaultPriorities() sets.String {
	return sets.NewString(
		...
		factory.RegisterPriorityConfigFactory(
			...
			kfactory.PriorityConfigFactory{
				Function: func(args kfactory.PluginFactoryArgs) algorithm.PriorityFunction {
