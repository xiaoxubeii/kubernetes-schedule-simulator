...
func (g *genericScheduler) Schedule(pod *v1.Pod, nodeLister algorithm.NodeLister) (string, error) {
	...
	glog.V(1).Infof("filternodes: %v", filteredNodes)
	...
	glog.V(1).Infof("priorityList: %v", priorityList)
	metrics.SchedulingAlgorithmPriorityEvaluationDuration.Observe(metrics.SinceInMicroseconds(startPriorityEvalTime))
...
func addNominatedPods(pod *v1.Pod, meta algorithm.PredicateMetadata,
	nodeInfo *schedulercache.NodeInfo, queue queue.SchedulingQueue) (bool, algorithm.PredicateMetadata,
